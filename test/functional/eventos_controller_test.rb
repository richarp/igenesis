...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { detalle: @evento.detalle, fechaf: @evento.fechaf, fechai: @evento.fechai, titulo: @evento.titulo }
    end
  ...
  test "should update evento" do
    put :update, id: @evento, evento: { detalle: @evento.detalle, fechaf: @evento.fechaf, fechai: @evento.fechai, titulo: @evento.titulo }
    assert_redirected_to evento_path(assigns(:evento))
  end
