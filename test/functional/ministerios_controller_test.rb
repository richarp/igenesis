...
class MinisteriosControllerTest < ActionController::TestCase
  ...
  test "should create ministerio" do
    assert_difference('Ministerio.count') do
      post :create, ministerio: { encargado: @ministerio.encargado, mision: @ministerio.mision, nombre: @ministerio.nombre, vision: @ministerio.vision }
    end
  ...
  test "should update ministerio" do
    put :update, id: @ministerio, ministerio: { encargado: @ministerio.encargado, mision: @ministerio.mision, nombre: @ministerio.nombre, vision: @ministerio.vision }
    assert_redirected_to ministerio_path(assigns(:ministerio))
  end
